...
const Signup = () => {
    ...
    const handleSubmit = (e) => {
        ...
        else if (!validatePassword(password)) errors.push("Password must be at least 6 characters long and include an uppercase letter, a number, and a special character");
        if (!role) errors.push("Role selection is required");  // Validate role selection
        ...
        axios.post(`${API_BASE_URL}/admin/signup`, { name, email, password, role })  // Include role in request
            .then((res) => {
            ...
            <div className="flex flex-col md:flex-row border rounded-lg shadow-lg bg-white overflow-hidden w-full max-w-4xl">
                ...
                <div className="flex flex-col justify-center items-start w-full md:w-1/2 p-6">
                    ...
                    <form onSubmit={handleSubmit} className="w-full mt-4">
                        ...
                        <input
                            type="text"
                            className={`block w-full p-3 mb-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500`}
                            placeholder="Name"
                            value={name}
