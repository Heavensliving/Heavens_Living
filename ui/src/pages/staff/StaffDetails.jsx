...
const StaffDetails = () => {
  ...
  const [isSalaryModalOpen, setIsSalaryModalOpen] = useState(false); // State for SalaryDetails modal
  const [slideIn, setSlideIn] = useState(false); // Slide-in effect for SalaryDetails modal
  ...
  // Function to handle opening the SalaryDetails modal
...
export default CheckAuth(StaffDetails);
