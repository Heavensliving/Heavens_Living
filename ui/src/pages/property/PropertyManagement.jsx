...
import { FaFilter, FaPlus, FaUsers, FaCheck, FaRegCircle, FaHome } from 'react-icons/fa';
...
const PropertyManagement = () => {
  const navigate = useNavigate()
   ...
   const properties = [
    { id: 1, name: 'Beautiful House', location: 'New York', price: '$300,000', occupancy: 5, occupied: 3, vacant: 2 },
    { id: 2, name: 'Modern Apartment', location: 'Los Angeles', price: '$450,000', occupancy: 4, occupied: 2, vacant: 2 },
    { id: 3, name: 'Cozy Cottage', location: 'Chicago', price: '$250,000', occupancy: 3, occupied: 1, vacant: 2 },
    { id: 4, name: 'Luxury Villa', location: 'Miami', price: '$1,200,000', occupancy: 6, occupied: 5, vacant: 1 },
    { id: 5, name: 'Spacious Condo', location: 'San Francisco', price: '$800,000', occupancy: 7, occupied: 4, vacant: 3 },
    { id: 6, name: 'Charming Bungalow', location: 'Seattle', price: '$400,000', occupancy: 3, occupied: 2, vacant: 1 },
  ];
      ...
      {filteredProperties.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredProperties.map(property => (
            <div key={property.id} className="bg-white p-4 rounded-lg border border-gray-300 cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
              ...
              <div className="flex justify-between mb-2">
                ...
                <div className="text-right">
                  ...
                  <p className="text-grey-500 font-bold">{property.price}</p>
                </div>
              </div>
