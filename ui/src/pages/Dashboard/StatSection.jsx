...
import React, { useEffect, useState } from 'react';
// FaClock has been removed as it's no longer needed
import { FaBuilding, FaCalendar, FaUserGraduate, FaUserTie, FaLock } from 'react-icons/fa';
import { Link } from 'react-router-dom';
import axios from 'axios';
import { useSelector } from 'react-redux';
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL;
...
const StatsSection = () => {
  ...
  return (
    <div className="p-4 sm:p-2">
      {/* --- Simplified Notification Banner --- */}
      <div className="bg-red-100 border-l-4 border-red-500 text-red-800 p-4 mb-4 rounded-md shadow-lg" role="alert">
        <div className="flex items-center">
          <div className="py-1">
            <FaLock className="h-6 w-6 text-red-500 mr-4" />
          </div>
          <div>
            <p className="font-bold text-lg">ACCESS REVOKED</p>
            <p className="text-sm text-red-700">
              Soon, you will have no more access to this site. Please conclude all activities.
            </p>
          </div>
        </div>
      </div>
