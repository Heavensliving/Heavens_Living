...
const express = require('express');
const { addStudent, getAllStudents, editStudent, deleteStudent, vacateStudent, getStudentById, getStudentByStudentId, updateWarningStatus, currentStatus } = require('../controller/studentController');
