...
function ManagePeoplePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <h2 className="text-3xl font-bold text-center mb-6">Manage People</h2>
        ...
        <table className="min-w-full bg-white border">
          <thead>
            <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
              ...
              <th className="py-3 px-6 text-left">Time Period (Months/Days)</th>
                ...
                <tr key={person.id} className="border-b border-gray-200 hover:bg-gray-100">
                  ...
                  <td className="py-3 px-6 text-center">
                    <button
                      ...
                      className="bg-blue-500 text-white px-3 py-1 mr-2 rounded-lg"
                    >
                      Edit
                    </button>
                    <button
